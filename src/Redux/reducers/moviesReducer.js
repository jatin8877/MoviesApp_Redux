import {LOAD_MOVIES, LOAD_MOVIES_HINDI} from '../actions/actions';
...
const moviesReducer = (state = initialState, action) => {
  switch (action.type) {
    case LOAD_MOVIES:
      return {
        hollywoodmovies: [...state.hollywoodmovies],
      };
    case LOAD_MOVIES_HINDI:
      return {
        bollywoodmovies: [...state.bollywoodmovies],
      };
    default:
      return state;
  }
